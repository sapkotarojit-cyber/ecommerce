...
@section('title', 'Register - Empireinnovation')
<title>Register - EmpireInnovation</title>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <div class="text-center mb-8">
                <div class="w-16 h-16 bg-[#c9a84c]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="fas fa-user-plus text-3xl text-[#c9a84c]"></i>
                </div>
                <h2 class="text-2xl font-bold text-[#1a2a6c]">Create an Account</h2>
                <p class="text-gray-500 text-sm mt-1">Join Empireinnovation today</p>
            </div>
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                ...
                <a href="{{ route('login') }}" class="text-[#c9a84c] font-semibold hover:text-[#b8963a]">Sign In</a>
            </p>
        </div>
    </div>
</section>
